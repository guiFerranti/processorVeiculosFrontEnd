...
const RegisterVeiculo: React.FC = () => {
    ...
    return (
        <div className="container mx-auto p-4 max-w-lg">
            <h1 className="text-3xl font-bold mb-6 text-center w-full">Registrar Veículo</h1>
            <ToastContainer />
            <form onSubmit={formik.handleSubmit} className="space-y-6">
                ...
                <div className="relative pb-7">
                    <label className="block text-left font-medium text-gray-300">Marca</label>
                    <input
                ...
                <div className="relative pb-7">
                    <label className="block text-left font-medium text-gray-300">Modelo</label>
                    <input
                ...
                <div className="relative pb-7">
                    <label className="block text-left font-medium text-gray-300">URL da Imagem (opcional)</label>
                    <input
